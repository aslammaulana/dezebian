...
import { Plus, MoreHorizontal, Pencil, Trash2, LayoutTemplate, Telescope } from 'lucide-react'
                ...
                {editingId === t.id ? (
                    ...
                    <>
                        <button
                            ...
                            className={clsx(
                                'flex w-full items-center gap-2 rounded-lg px-3 py-2 text-[13px] font-medium transition-colors text-left cursor-pointer',
                                isActive
    ...
    return (
        <aside className="flex h-full w-[220px] flex-col shrink-0 border-r border-[#27272a] bg-[#141414] overflow-y-auto scrollbar-thin">
            ...
            <div className="p-4 flex flex-col gap-1">
                ...
                >
                    <Telescope size={15} className="shrink-0 text-sky-400" />
                    <span className="flex-1 truncate">ATM Browser</span>
                </Link>

                <button
                    onClick={() => onSelectTable('all')}
                    className={clsx(
                        'mb-2 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-[13px] font-medium transition-colors text-left cursor-pointer',
                        activeTableId === 'all'
                            ? 'bg-[#27272a] text-white'
                            : 'text-zinc-400 hover:bg-[#27272a] hover:text-white'
                    )}
